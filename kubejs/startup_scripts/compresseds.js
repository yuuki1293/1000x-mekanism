...
onEvent('item.registry', event => {
    ...
    event.create('mek1000:crystal_fluorite').tag('mekanism:crystals').displayName("Certus Fluorite").tooltip("蛍石のおいしい結晶... ってこれ完成品よりきれい？")
    ...
    event.create('mek1000:crystal_quartz').tag('mekanism:crystals').displayName("Certus Quartz").tooltip("ネザークオーツのおいしい結晶... おいしそう...")
